...
export default function Loader() {
  ...
  return (
    <div className={`fixed inset-0 bg-deep flex flex-col items-center justify-center z-[9999]
      ...
      <div className="text-cream/40 text-xs tracking-[0.2em] mt-1.5 animate-fade-up" style={{ animationDelay:'0.3s', animationFillMode:'both' }}>
        INDORE · EST. 2007
      </div>
